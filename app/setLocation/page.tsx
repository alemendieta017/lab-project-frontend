...
const SetLocation = () => {
  ...
  return (
    <div className='fade-in-animation min-h-screen bg-gradient-to-t from-gray-300 to-30% p-4 py-20'>
      <div className='container relative m-auto flex flex-col gap-y-6 lg:max-w-5xl'>

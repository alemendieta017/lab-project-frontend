...
const SetLocation = () => {
  ...
  return (
    <div className='fade-in-animation absolute min-h-screen w-full bg-gradient-to-t from-gray-300 to-30% p-4 py-20'>
      <div className='container relative z-10 m-auto flex flex-col gap-y-6 lg:max-w-5xl'>
